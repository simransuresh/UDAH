function [vgrid,vgriderror,vdata,vdataerror]=mapping11(v,posfloat,...
...
% posfloat 1*4  vector of float location [latitude,longitude,dates,waterdepth]
% posdata  m1*4 matrix of data locations [latitude,longitude,dates,waterdepth]
...
%    
[Cdd] = s*covar1(posdata,posdata,lam,phi,q);
...
for j=1:mmm,
    [Cmd] = s*covar1(posdata(j,:),posdata,lam,phi,q);
...
[Cmd] = s*covar1(posfloat,posdata,lam,phi,q);
...
%disp('mapping fct 1st stage...')

%%%if abs(vgrid)>100, disp('mapping11.m 78'), keyboard; end
